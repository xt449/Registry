...
public class KeyIdRegistry<Key, Value> implements IIdRegistry<Key, Value> {
	...
	public static class Registration<Key, Value> implements IIdRegistration<Value> {
